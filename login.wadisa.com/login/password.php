            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2 class="section-heading">RESTART PASSWORD</h2>
                        <h3 class="section-subheading text-muted">Write your mail and we send the new password.</h3>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="Your email *" name="user" id="user" required autofocus data-validation-required-message="Please include a valid email.">
                                        <input type="hidden" name="type" class="form-control" id="type" value="sendpass">  
                                        <p class="help-block text-danger"></p>
                                    </div>

                                </div>
                                <input type="hidden" name="type" class="form-control" id="type" hidden="true" value="sendpass">  
