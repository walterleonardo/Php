    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top"><img src="../imagenes/buhogif.gif" width="50px"><?php echo $empresa; ?></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="password.php">RESTART PASSWORD</a>
                    </li>
                  </ul>
            </div>
            <!-- /.navbar-collapse -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div style="margin-bottom: 25px" class="input-group">
                                    ...
                                    <input type="email" class="form-control" placeholder="Your Email *" id="user" required autofocus data-validation-required-message="Please include a valid email.">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div style="margin-bottom: 25px" class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                    <input type="password" class="form-control" placeholder="Password *" id="pass" required data-validation-required-message="Please include a password.">
                                    <p class="help-block text-danger"></p>
                                </div>
                                 <div style="margin-bottom: 25px" class="input-group">
                                 <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                    <input type="password" class="form-control" placeholder="Repeat password *" id="rpass" required data-validation-required-message="Please include a password again.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
