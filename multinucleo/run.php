<?php
	include_once('getVarPSFILTER.php');
	$debug=false;
	...
	$demoInfo='PSFILTER |164|prod|1|Y|14,24,34,44,54,64|||||1~5#5#10~N~N,2~2#3#6~N~N||';
		...
		//echo "#################################\n";
		//print_r(convertRequestArrayToString(array('|',',','~','#'),$arrayIndexAfterBool));
		//echo "\n";
		//echo "#################################\n";

		//print_r($arrayIndexAfterBool);
		//$arrString = implode('|',$arrayIndexAfterBool);
		//echo 'ARRAY: $arrayIndexAfterBool\n';
		echo "#################################\n";
echo "ANSWER FROM SERVER: \n";
	$answer = callPrefilter($arrayIndexAfterBool);
	print_r($answer);
	echo "#################################\n";
